...
export default function GlassCTA({
  ...
  return (
    <div className="relative inline-flex items-center justify-center">
      ...
      <div
        className="pointer-events-none absolute inset-0 rounded-full border border-indigo-400/20"
        style={{ animation: "grav-ripple 3s ease-out infinite" }}
      />
      <div
        className="pointer-events-none absolute inset-0 rounded-full border border-indigo-400/15"
        style={{ animation: "grav-ripple 3s ease-out 1s infinite" }}
      />
      <div
        className="pointer-events-none absolute inset-0 rounded-full border border-indigo-400/10"
        style={{ animation: "grav-ripple 3s ease-out 2s infinite" }}
      />
